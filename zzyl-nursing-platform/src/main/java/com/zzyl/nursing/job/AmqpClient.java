...
public class AmqpClient implements ApplicationRunner {
    ...
    private void processMessage(Message message) {
        ...
        try {
            ...
            String jsonStr = jsonObject.getStr("notify_data");
            ...
            for (IotMsgService service : services) {
                ...
                for (Map.Entry<String, Object> entry : properties.entrySet()) {
                    ...
                    DeviceData deviceData = DeviceData.builder().deviceName(device.getDeviceName())
                            .iotId(device.getIotId())
                            .productKey(device.getProductKey())
                            .productName(device.getProductName())
                            .functionId(functionId)
                            .dataValue(String.valueOf(dataValue))
                            .accessLocation(String.valueOf(device.getBindingLocation()))//接入位置
                            ...
                            .alarmTime(alarmTime)
                            .build();
                    deviceData.setRemark(device.getRemark());
                    list.add(deviceData);
                }
            }
